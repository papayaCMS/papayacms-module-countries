...
* @version $Id: connector_countries.php 39734 2014-04-08 19:01:37Z weinert $
*/
...
class connector_countries extends base_plugin {
  ...
  */
   ...
   * @see country_admin::callbackContinent()
   */
  function callbackCountries(
    $name, $field, $data, $lngId, $paramName = NULL, $continentId = NULL, $countryCaption = NULL
  ) {
    $countryAdmin = $this->countryAdmin();
